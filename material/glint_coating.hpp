...
#ifndef NN_RENDER_MATERIAL_GLINT_COATING_HPP
#define NN_RENDER_MATERIAL_GLINT_COATING_HPP
...
///////////////////////////////////////////////////////////////////////////////////////////////////
//glint_coating_material
/*/////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////*/

class glint_coating_material : public material
{
public:
	
	struct bindless_material : bindless_material_base
	{
		bindless_material(texture_resource_ptr& p_alpha_map, texture_resource_ptr& p_displacement_map, const float max_displacement) : bindless_material_base(material_type_glint_coating, p_alpha_map ? p_alpha_map->srv().bindless_handle() : -1, p_displacement_map ? p_displacement_map->srv().bindless_handle() : -1, max_displacement)
		{
		}
	...
	//コンストラクタ
	glint_coating_material() : material(material_type_glint_coating)
	{
		m_has_update = true;
	}
