...
#ifndef MATERIAL_GLINT_COATING_HLSL
#define MATERIAL_GLINT_COATING_HLSL
...
float3	get_coat_normal(glint_coating_material mtl){ return oct_to_f32x3(u16x2_unorm_to_f32x2(mtl.coat_normal) * 2 - 1); }
float3	get_base_normal(glint_coating_material mtl){ return oct_to_f32x3(u16x2_unorm_to_f32x2(mtl.base_normal) * 2 - 1); }
float3	get_sheen_color(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.sheen_color).xyz; }
float	get_sheen_roughness(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.roughness).x; }
float3	get_sheen_reflectance(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.sheen_reflectance).xyz; }
float	get_coat_scale(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.scale).x; }
float3	get_coat_color0(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.coat_color0).xyz; }
float	get_coat_roughness(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.roughness).y; }
float3	get_coat_reflectance(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.coat_reflectance).xyz; }
float	get_specular_scale(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.scale).y; }
float3	get_specular_color0(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.specular_color0).xyz; }
float	get_specular_roughness(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.roughness).z; }
float3	get_specular_reflectance(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.specular_reflectance).xyz; }
float3	get_matte_reflectance(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.matte_reflectance).xyz; }
float3	get_diffuse_color(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.diffuse_color).xyz; }
float	get_diffuse_roughness(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.roughness_subsurface_misc).x; }
float3	get_diffuse_reflectance(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.diffuse_reflectance).xyz; }
float	get_subsurface(glint_coating_material mtl){ return r10g10b10a2_to_f32x4(mtl.roughness_subsurface_misc).y; }
float3	get_subsurface_radius(glint_coating_material mtl){ return r9g9b9e5_to_f32x3(mtl.subsurface_radius); }
bool	is_twoside(glint_coating_material mtl){ return mtl.flags_glint_cell_size & 1; }

float2	get_patch_center(glint_coating_material mtl) { return mtl.patch_center; }
float2	get_patch_axis0(glint_coating_material mtl){ return mtl.patch_axis0; }
float2	get_patch_axis1(glint_coating_material mtl){ return mtl.patch_axis1; }
float	get_lod_bias(glint_coating_material mtl){ return 2; }
float	get_cell_size(glint_coating_material mtl){ return f16tof32(mtl.flags_glint_cell_size >> 16); }

///////////////////////////////////////////////////////////////////////////////////////////////////

struct glint_coating_material_host
{
	//0
...
glint_coating_material load_glint_coating_material(intersection isect, float3 wo, float lod = 0, uint2 dtid = 0)
{
...
bool has_contribution(float nwi, glint_coating_material mtl)
{
...
void calc_bsdf_pdf(float3 wo, float3 wi, float3 normal, glint_coating_material mtl, out float3 diffuse, out float3 non_diffuse, out float pdf, uint2 dtid = 0)
{
	pdf = 0;
	diffuse = 0;
	non_diffuse = 0;
...
float4 calc_bsdf_pdf(float3 wo, float3 wi, float3 normal, glint_coating_material mtl, uint2 dtid = 0)
{
	float pdf;
...
float3 calc_subsurface(glint_coating_material mtl)
{
	float3 throughput = 1;
...
bsdf_sample sample_bsdf(float3 wo, float3 normal, glint_coating_material mtl, float u0, float u1, uint2 dtid = 0)
{
	float3 throughput = 1;
	...
	else if(sample_type == 1)
	{
		...
		s.is_valid = glint::sample_brdf(coat_wo, s.w, get_coat_color0(mtl), get_coat_roughness(mtl), get_patch_center(mtl), get_patch_axis0(mtl), get_patch_axis1(mtl), get_cell_size(mtl), get_lod_bias(mtl), u0, u1);
		if(!s.is_valid)
			return s;
	}
	//base
