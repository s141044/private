...
//コンストラクタ
inline debug_draw::debug_draw(const uint capacity) : m_front(), m_capacity(capacity)
{
...
//ライン描画
inline debug_draw::vertex* debug_draw::draw_lines(const uint num_lines)
{
	return draw_xxx(2 * num_lines, draw_type_line);
}

inline debug_draw::vertex* debug_draw::draw_line_strip(const uint num_lines)
{
...
//ポイント描画
inline debug_draw::vertex* debug_draw::draw_points(const uint num_points)
{
	return draw_xxx(num_points, draw_type_point);
}

///////////////////////////////////////////////////////////////////////////////////////////////////

//遅延描画
inline void debug_draw::draw(std::function<void()> func)
{
	m_draw_queue.push(std::move(func));
}
