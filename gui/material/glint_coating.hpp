...
#ifndef NN_RENDER_GUI_MATERIAL_GLINT_COATING_HPP
#define NN_RENDER_GUI_MATERIAL_GLINT_COATING_HPP

#include"../../material/glint_coating.hpp"
...
class glint_coating_material : public property_editor
{
public:

	glint_coating_material(render::glint_coating_material& mtl, string name = "glint_coating_material") : property_editor(std::move(name)), m_mtl(mtl)
	{
	}
...
private:
	...
	render::glint_coating_material& m_mtl;
};
